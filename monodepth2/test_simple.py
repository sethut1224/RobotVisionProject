...
def test_simple(args):
    ...
    if os.path.isfile(args.input_path):
        ...
        output_directory = os.path.dirname(args.input_path)
    elif os.path.isdir(args.input_path):
        # Searching folder for images
        paths = glob.glob(os.path.join(args.input_path, '*.{}'.format(args.ext)))
        output_directory = args.output_path
    else:
        raise Exception("Can not find args.input_path: {}".format(args.input_path))
    ...
    with torch.no_grad():
        for idx, input_path in enumerate(paths):
            ...
            if input_path.endswith("_disp.jpg"):
            ...
            # print(disp_resized.shape) # original
            # Saving numpy file
